        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="http://layuimini.99php.cn" target="_blank"><i class="layui-icon layui-icon-theme"></i> layuinimi官方网站</a>\n' +
                    '<a class="more-menu-item" href="https://github.com/Green1hand/Dome1" target="_blank"><i class="layui-icon layui-icon-theme"></i> github位置</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
