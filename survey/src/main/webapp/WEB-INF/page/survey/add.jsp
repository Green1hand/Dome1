...
<div class="layuimini-container">
    <div class="layuimini-main">
        <form class="layui-form" action="" lay-filter="example">
            ...
            %>
            <input type="hidden" name="account" lay-verify="required" autocomplete="off" value="<%=admin%>" class="layui-input">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="bounds" lay-filter="bounds" lay-search="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="rules" lay-filter="rules" lay-search="">
